    ...
    <div class="mainstages d-flex mx-3 overflow-x-auto">
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="d-grid gap-2 col-6 mx-auto">
              <button class="btn addNewStage" type="button" @click="postStage()" @input-confirmed="updateStageName">Criar Etapa</button>
            </div>
          </div>
          </div>
        </div>
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" :id="offcanvasUpdateContact">
